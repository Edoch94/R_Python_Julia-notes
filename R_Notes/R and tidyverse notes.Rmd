...
dt_mtcars <- lazy_dt(mtcars, immutable = F) # il parametro immutable obbliga dtplyr a non creare copie della dt, cosa che succede se il codice dplyr contiene dei mutate che vanno a modificare campi esistenti 
